...
| P6-03 | Final review, cancellation and resumption interface | Complete; component tests, build and both browser sizes passed |
...
| P6-05 | Full validation, measured results and final review | Complete; full regression suite, local recovery and documentation checks passed |

See [ADR-006](../adr/0006-controlled-submission.md). The implemented channel is
a local simulation, with no employer delivery or new cloud deployment.
...
the [validation record](validation.md) and [metrics](metrics.json) for measured results.
