...
| Etapa | Escopo | Estado |
|---|---|---|
| P3-01 | Contratos, permissões de uso e snapshots | Em implementação |
| P3-02 | Estratégia, revisão e geração versionada | Pendente |
| P3-03 | CV, cover letter, respostas e downloads DOCX/PDF/JSON | Pendente |
